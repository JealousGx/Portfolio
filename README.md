...
Just simply clone / fork this repository and run ```npm install``` as the Node version might not be compatible. After that, simple run ```npm run dev```, and you are good to go.
