...
export const mvpDevelopment: ServicePageData = {
  ...
  objection: {
    ...
    answer:
      "For some ideas, yes, and I'll tell you if that's the better starting point. But if your idea needs real logic, integrations, or you'll want to keep building on it long-term, a properly scoped custom MVP avoids hitting a wall, and a rebuild, later.",
  },
  experience:
  ...
  faqs: [
    {
      ...
      answer:
        "Scoped after a quick call. Depends entirely on what the MVP needs to prove.",
    },
    {
      question: "How long does an MVP take to build?",
      answer:
        "Depends on scope, but the whole point of an MVP is to keep it tight. I'll give you a real timeline on a call, not a guess here.",
    },
    {
    ...
    {
      question:
        "Can you help me hire a developer for a startup, or do you only build solo?",
      answer:
        "I typically work solo end-to-end, but I'm open to contract-to-hire if your startup is looking to bring someone on longer-term.",
    },
    {
      question: "I'm not technical. Can you still help me build an MVP?",
      answer:
        "Yes, that's actually a common starting point. I'll ask the right questions to understand what you need, and you won't need to know the technical details to work with me.",
    },
    {
      question: "Are you available as a freelance MVP developer for a startup?",
      answer:
        "Yes, this is a core part of what I do, including my own self-built products.",
    },
    {
